...
public struct DemoVRTheme: Theme {
    ...
    // Brand — VR blue accent (matches VRColorScale.accent)
    ...
    public var chartSecondary: Color { Color(red: 0.976, green: 0.451, blue: 0.086) } // orange for secondary chart series
